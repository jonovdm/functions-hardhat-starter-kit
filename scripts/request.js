...
async function main() {
  ...
  // Consumer contract
  const consumerAddress = "0x919491A0625e296A3A0361494798cC01429c8A26"
  ...
  // Default example
  const source = await fs.readFile("./scripts/r.js", "utf8")
  // const source = "./r.js"
  const args = ["squirtle"] //["1dc5dcec-20c0-11ee-ad2d-92520e0bb667"];
